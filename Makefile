...
KIND_CLUSTER ?= routines-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name routines-builder
	$(CONTAINER_TOOL) buildx use routines-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm routines-builder
	rm Dockerfile.cross
